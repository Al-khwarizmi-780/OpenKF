...
class CaMotionModel : public MotionModel<CaMotionModel, DIM_X_CA>
{
 public:
  ...
  Vector<DIM_X_CA> f(Vector<DIM_X_CA> const& vecX,
                     Vector<DIM_X_CA> const& vecQ = Vector<DIM_X_CA>::Zero(),
  ...
  Matrix<DIM_X_CA, DIM_X_CA> getProcessNoiseCov(float32_t sigma,
                                                float32_t dt = 1.0F) const;
