...
namespace kf
{
    ...
    public:
        ...
        virtual Vector<DIM_X> f(Vector<DIM_X> const & vecX, Vector<DIM_X> const & vecQ = Vector<DIM_X>::Zero()) = 0;

        /// @brief Get the process noise covariance Q
        /// @param vecX State space vector \vec{x}
        /// @return The process noise covariance Q
        virtual Matrix<DIM_X, DIM_X> getProcessNoiseCov(Vector<DIM_X> const & vecX) = 0; 
        ...
        virtual Matrix<DIM_X, DIM_X> getJacobianFk(Vector<DIM_X> const & vecX) = 0;
    };
    ...
    public:
        ...
        /// @param vecQ State white gaussian noise vector \vec{q}
        /// @return Predicted/ propagated state space vector
        virtual Vector<DIM_X> f(Vector<DIM_X> const & vecX, Vector<DIM_U> const & vecU, Vector<DIM_X> const & vecQ = Vector<DIM_X>::Zero()) = 0;

        /// @brief Get the process noise covariance Q
        /// @param vecX State space vector \vec{x}
        /// @param vecU Input space vector \vec{u}
        /// @return The process noise covariance Q
        virtual Matrix<DIM_X, DIM_X> getProcessNoiseCov(Vector<DIM_X> const & vecX, Vector<DIM_U> const & vecU) = 0; 

        /// @brief Get the input noise covariance U
        /// @param vecX State space vector \vec{x}
        /// @param vecU Input space vector \vec{u}
        /// @return The input noise covariance U
        virtual Matrix<DIM_X, DIM_X> getInputNoiseCov(Vector<DIM_X> const & vecX, Vector<DIM_U> const & vecU) = 0; 

        /// @brief Method that calculates the jacobians of the state transition model.
        /// @param vecX State Space vector \vec{x}
        /// @param vecU Input Space vector \vec{u}
        /// @return The jacobians of the state transition model.
        virtual Matrix<DIM_X, DIM_X> getJacobianFk(Vector<DIM_X> const & vecX, Vector<DIM_U> const & vecU) = 0;
        ...
        virtual Matrix<DIM_X, DIM_U> getJacobianBk(Vector<DIM_X> const & vecX, Vector<DIM_U> const & vecU) = 0;
    };
}
